"""
درگاه وندار (vandar) — REST — تجربی و تست‌نشده.
...
در registry عمومی نیست. فقط با import صریح در دسترس است:
    from django_iranian_payment.experimental import VandarGateway

نکات این درگاه: فین‌تک REST/JSON. callback از نوع POST. مبلغ به ریال.
...
class VandarGateway(BaseGateway):
    ...
    def initiate(self, request: PaymentRequest) -> InitiateResult:
        # TODO: payload را طبق مستندات وندار بساز.
