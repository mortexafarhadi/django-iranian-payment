"""
درگاه سپه (sepah) — SOAP — تجربی و تست‌نشده.
...
در registry عمومی نیست. فقط با import صریح در دسترس است:
    from django_iranian_payment.experimental import SepahGateway

نکات این درگاه: SOAP — به zeep نیاز دارد. callback از نوع POST.
...
class SepahGateway(BaseGateway):
    ...
    def initiate(self, request: PaymentRequest) -> InitiateResult:
        # TODO: payload را طبق مستندات سپه بساز.
