"""
درگاه ایران کیش (irankish) — REST — تجربی و تست‌نشده.
...
در registry عمومی نیست. فقط با import صریح در دسترس است:
    from django_iranian_payment.experimental import IrankishGateway

نکات این درگاه: رمزنگاری با کلید عمومی لازم است. callback از نوع POST.
...
class IrankishGateway(BaseGateway):
    ...
    def initiate(self, request: PaymentRequest) -> InitiateResult:
        # TODO: payload را طبق مستندات ایران کیش بساز.
