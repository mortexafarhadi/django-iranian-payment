"""
درگاه سامان کیش (saman) — REST — تجربی و تست‌نشده.
...
در registry عمومی نیست. فقط با import صریح در دسترس است:
    from django_iranian_payment.experimental import SamanGateway

نکات این درگاه: initiate توکن می‌گیرد سپس فرم POST به درگاه. callback از نوع POST.
...
class SamanGateway(BaseGateway):
    ...
    def initiate(self, request: PaymentRequest) -> InitiateResult:
        # TODO: payload را طبق مستندات سامان کیش بساز.
