...
def callback(request):
    ...
    # رکورد را گم نکند و reverify_pending با همین extra (tracking_code) بگیردش.
...
def reverify_pending():
    """رکوردهای معلق دیجی‌پی (درگاه در callback بی‌پاسخ داده بود) را دوباره verify می‌کند. cron."""
